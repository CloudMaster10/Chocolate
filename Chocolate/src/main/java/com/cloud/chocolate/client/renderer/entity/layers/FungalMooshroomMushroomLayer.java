package com.cloud.chocolate.client.renderer.entity.layers;
...
@OnlyIn(Dist.CLIENT)
public class FungalMooshroomMushroomLayer<T extends FungalMooshroomEntity> extends LayerRenderer<T, CowModel<T>>
{
	public FungalMooshroomMushroomLayer(IEntityRenderer<T, CowModel<T>> rendererIn)
	{
		super(rendererIn);
	}
	...
	public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch)
	{
		if (!entitylivingbaseIn.isChild() && !entitylivingbaseIn.isInvisible())
		{
			...
			BlockState blockstate = entitylivingbaseIn.getFungalMooshroomType().getRenderState();
			int i = LivingRenderer.getPackedOverlay(entitylivingbaseIn, 0.0F);
			matrixStackIn.push();
			matrixStackIn.translate((double) 0.2F, (double) -0.15F, 0.5D);
			...
			matrixStackIn.translate(0.0D, (double) -0.6F, (double) -0.2F);
