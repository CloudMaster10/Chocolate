package com.cloud.chocolate.client.renderer.entity.model;
...
@OnlyIn(Dist.CLIENT)
public class ModBoatModel extends SegmentedModel<BoatEntity>
{
	...
	public ModBoatModel()
	{
		ModelRenderer[] amodelrenderer = new ModelRenderer[] { (new ModelRenderer(this, 0, 0)).setTextureSize(128, 64),
