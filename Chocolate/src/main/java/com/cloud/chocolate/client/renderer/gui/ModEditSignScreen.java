...
public class ModEditSignScreen extends Screen
{
	...
	public void render(int redRender, int greenRender, float blueRender)
	{
		...
		IVertexBuilder ivertexbuilder = irendertypebuffer$impl.getBuffer(RenderType.getEntityCutoutNoCull(ModSignTileEntityRenderer.getTexture(blockstate)));
		...
		super.render(redRender, greenRender, blueRender);
	}
}