package com.cloud.chocolate.client.renderer.gui;
...
public class ModEditSignScreen extends Screen
{
	...
	protected void init() {
		...
		this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 120, 200, 20, DialogTexts.field_240632_c_,
				(p_238847_1_) -> {
					this.close();
				}));
		...
		}, TextInputUtil.func_238570_a_(this.minecraft), TextInputUtil.func_238582_c_(this.minecraft),
				(p_238848_1_) -> {
	...
	public void removed() {
		...
		if (clientplaynethandler != null) {
			clientplaynethandler.sendPacket(new CUpdateSignPacket(this.tileSign.getPos(), this.field_238846_r_[0],
					this.field_238846_r_[1], this.field_238846_r_[2], this.field_238846_r_[3]));
		}
	...
	public boolean charTyped(char p_231042_1_, int p_231042_2_) {
		this.textInputUtil.putChar(p_231042_1_);
		return true;
	}
	...
	public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
		...
		IVertexBuilder ivertexbuilder = rendermaterial.getBuffer(irendertypebuffer$impl,
				this.field_228191_a_::getRenderType);
		...
		for (int i1 = 0; i1 < this.field_238846_r_.length; ++i1) {
			...
			if (s != null) {
				...
				this.minecraft.fontRenderer.func_238411_a_(s, f3, (float) (i1 * 10 - this.field_238846_r_.length * 5),
				...
				if (i1 == this.editLine && j >= 0 && flag1) {
					...
					if (j >= s.length()) {
						this.minecraft.fontRenderer.func_238411_a_("_", (float) k1, (float) l, i, false, matrix4f,
