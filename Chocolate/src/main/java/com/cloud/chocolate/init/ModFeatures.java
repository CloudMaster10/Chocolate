...
{
	/*
	public static final Feature<TreeFeature> PALM_TREE = new PalmTreeFeature(BaseTreeFeatureConfig::deserializeFoliage);
	public static final Feature<TreeFeature> SAKURA_TREE = new TreeFeature(TreeFeatureConfig::deserializeFoliage);
	public static final Feature<TreeFeature> FANCY_SAKURA_TREE = new FancyTreeFeature(TreeFeatureConfig::deserializeFoliage);
	*/
